        ...
        <div className="flex-1 max-w-2xl mb-12 space-y-8">
          ...
          >
            <div className="w-[494px] justify-center text-white/70 text-xl leading-loose">
              Browse expertly designed routines that match your goals, style,
              and schedule — whether you are training at home or in the gym.
            </div>
          </AnimatedSection>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-8 gap-x-24">
            {workouts.map((workout, index) => (
              <AnimatedSection
                ...
                distance="translate-y-10"
              >
                <div className="bg-white/5 rounded-[24px] p-2 w-[350px] flex items-center gap-4 transition-all duration-300">
                  {/* Left Image */}
